...
public class Node {
	...
	/**
	 * Determines if the conditions for executing the algorithm are met for the
	 * node. if the nodes is a terminal node return true, if the node is the root
	 * check if all s values in the tree are the same
	 * 
	...
	/**
	 * Checks the value of the 's' attribute for the root node always return false
	 * for the root one of the algorithm laws
	 * 
