...
public class HelloApplication extends Application {
	...
	public void start(Stage stage) throws IOException {
		...
		conditions.setStyle("-fx-padding: 10;" + "-fx-font-size: 20;" + "-fx-border-style: solid inside;"
				+ "-fx-border-width: 2;" + "-fx-border-height: 2;" + "-fx-border-insets: 15;" + "-fx-border-radius: 5;"
		...
		info.setStyle("-fx-padding: 10;" + "-fx-border-style: solid inside;" + "-fx-border-width: 2;"
				+ "-fx-border-height: 2;" + "-fx-border-insets: 15;" + "-fx-border-radius: 5;"
				+ "-fx-border-color: black;");

		// Create buttons for control
		Button stepButton = new Button("Step"); // Step button
		stepButton.setStyle(
				"-fx-background-color: #008CBA; -fx-text-fill: white; -fx-font-size: 16px; -fx-padding: 6px 10px; -fx-border-radius: 4px;"); // Style
																																				// the
																																				// button
		stepButton.setOnAction(e -> {
			stepButton.setStyle(
					"-fx-background-color: #ADD8E6; -fx-text-fill: black; -fx-font-size: 16px; -fx-padding: 6px 10px; -fx-border-radius: 4px;"); // Change
																																					// button
																																					// color
																																					// on
																																					// click
		...
		playButton.setStyle(
				"-fx-background-color: #4CAF50; -fx-text-fill: white;  -fx-font-size: 16px; -fx-padding: 6px 10px; -fx-border-radius: 4px;"); // Style
																																				// the
																																				// button
		...
		controls.getChildren().addAll(numNodesLabel, numNodesTextField, playButton, stepButton, pauseButton, statistics,
				info);
